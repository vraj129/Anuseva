...
public class CurveBottomNavigationView extends BottomNavigationView {
   ...
   //Declare variable
    ...
    public CurveBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
